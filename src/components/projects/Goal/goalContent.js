...
export const content = [
  {
    ...
    content: [
      {
        type: "link",
        url: "https://github.com/KovaKreative/GOAL",
        text: "GitHub Repo"
      },
      {
        type: "paragraph",
        text: "GOAL is an acronym that stands for Growth Organization Achievement Life. This project consists of two main features: the goal manager and the accountability buddy system."
      },
      {
        type: "image",
        url: goalManager,
      ...
      {
        type: "paragraph",
        text: "The goal manager allows the user to establish a long-term goal and then create a list of milestones required to achieve that goal. Each milestone can then contain its own set of milestones, breaking down every big, overwhelming task into smaller, more manageable ones. Every task or milestone that’s marked as complete contributes to the overall progress of the long-term goal, so with every small accomplishment, the user can see their progress bar grow, which, hopefully, encourages them to keep going."
      },
      {
        type: "image",
        url: buddyView,
        caption: "Finding an Accountability Buddy"
      },
      {
        type: "paragraph",
        text: `The accountability buddy system allows a user to find another user with similar goals, (or search for a specific user name) and connect with them in order to encourage each other and keep each other accountable for working toward their goals via live chat. The user can see their buddy’s long-term goals and how far along they are in achieving those goa
...
In addition, I took the initiative to handle the general cleanup and refactoring within every module and component and ended up doing extensive debugging on the entire project, whenever certain edge cases crept up near the end of our deadline.`
      },
    ]
  },
  {
...
Our app utilized several different panels, each of which was used to display a variety of information dynamically. Having to juggle multiple states and data, we decided to use React-Redux and the Redux Toolkit to manage all of the information. This allowed us to handle our states independent of our components and to leverage them in multiple components.`
  ...
  },
  {
    ...
    content: [
      {
        type: "video",
        url: "https://www.youtube.com/embed/Je-H89G8CmQ?origin=http://kovakreative.com",
        title: "GOAL Video Walkthrough"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: "image",
        url: landing,
        caption: "Landing Page With Colour Scheme"
      },
    ]
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: `The goal manager is the most extensive and complex feature of the app. It has one particular feature which we had second thoughts about implementing due to its complexity and our impending deadline.
